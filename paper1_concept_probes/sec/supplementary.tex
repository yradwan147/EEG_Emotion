...
Spanish & 0.681 & \textbf{0.899} & \textbf{0.781} \\
...
The 9-class accuracy is high ($>\!0.59$) across all three languages tested,
confirming that the nine story centroids capture a discriminative axis
even in non-English. Binary valence AUC is strongest in Spanish (0.90)
and weaker in English (0.54) --- the latter is likely an artifact of the
small (n=72) held-out set, since the same model achieves AUC 0.868 on
the independent SST-2 test.
