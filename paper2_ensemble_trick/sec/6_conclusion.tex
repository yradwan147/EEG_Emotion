...
The trick is validated across 9 benchmarks spanning three modalities
(EEG, images, text) and three architectures (axial transformer, small
CNN, ResNet-18, MLP, DistilBERT). It achieves a new state of the art on
FACED 9-class EEG emotion classification ($\facedacc$ BAcc, $+8.2\%$
over the prior EMOD AAAI 2026 baseline of $0.642$, and $+1.1$~pp above
a true 10-seed same-length deep ensemble at $0.6838$). The gain scales inversely with
