...
trace this to a regularity we call \emph{saturation}: once a network
has converged from task labels alone, its features already encode the
target concept; the auxiliary loss then adds gradient noise rather
than information. Saturation is distinct from
