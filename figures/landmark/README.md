...
| `lf2_eeg_llm_circle.pdf` | §4 main. 28 stim scatter (CLIP V-axis vs PO3/γ EEG); permutation null; 18-LLM brain rank with Qwen-1.5B leading. | r=+0.874, p<10⁻⁹; random-direction r=+0.07; Qwen-1.5B r=+0.411 leads 18-LLM rank | `reports/r6_eeg_llm_circle.json`, `reports/eeg_llm_extra/results.json` |
