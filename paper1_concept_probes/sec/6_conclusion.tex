...
better-than-random classifier; nine stories per class match a supervised
logistic regression trained on $\sim\!80$--$100$ labeled examples, a
$\sim\!10$--$30\times$ reduction in labeled data.
