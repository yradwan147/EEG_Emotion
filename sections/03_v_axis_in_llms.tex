...
ablation~\citep{arditi2024refusal} on Qwen3-4B's own features
collapses zero-shot SST-2 from $0.832$ to chance ($0.505$): the
V-axis is the direction Qwen3-4B uses for sentiment, not a post-hoc
projection.
