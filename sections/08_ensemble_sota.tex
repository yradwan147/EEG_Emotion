...
leaves BACC statistically unchanged ($\Delta{=}{-}0.004$, paired
$p{=}0.37$) --- KD provides architectural regularisation without
semantic content. Visual cascade in
...
orthonormal directions) leaves BACC statistically unchanged
($\Delta{=}{-}0.004$, paired $p{=}0.37$), so KD imposes a
...
Ensemble gain concentrates in the within-class residual each seed
encodes differently ($r{=}{+}0.74$, $p{=}0.014$;
\S\ref{sec:convergence}); averaging cancels that seed-specific noise
without disturbing the shared basin. Mixing $e{=}100$ and $e{=}150$
checkpoints supplies the diversity axis---the mixed pool reaches
$0.6948$ versus $0.6798$ for $e{=}100$ alone. Headroom-monotonicity,
the $10$-checkpoint plateau, and the failure of cross-architecture
mixing are in Appendix~\ref{app:ensemble-extras}.
