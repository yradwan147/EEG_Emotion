...
uninterpretable without the receiving baseline's saturation state. Our
three results---a saturation regularity organising $25$ recipe failures, a seed-ensemble (bias--variance over the
load-bearing residual) that turns it into FACED-9 SOTA, and the V-axis
probe---are
