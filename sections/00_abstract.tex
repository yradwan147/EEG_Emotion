...
on FACED, at $0.6287$. The SOTA recipe itself uses a structural KD step on the weaker
pre-saturation baseline, distinct from the $25$ semantic-V-axis
failures on the already-saturated baseline; confirming this, replacing
the SOTA-recipe LLM prototypes with random orthonormal vectors costs
$\le 0.003$ BACC---the gain is the $9$-direction \emph{shape}, not
the prototype \emph{content}. To probe what the network has
