...
training lengths), the class-mean subspace encodes the V-axis at a
consistent strength ($|r|\in[0.60, 0.77]$, unsigned): every
well-trained seed of this architecture converges onto the same
class-mean direction up to sign. This is the \emph{saturated
