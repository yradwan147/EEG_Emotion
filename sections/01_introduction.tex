...
\begin{figure}[t]
\centering
\includegraphics[width=0.78\linewidth]{landmark/fig1_hero_v6.pdf}
...
($0.658{\to}0.629$, $\Delta{=}{-}0.029$, $p{=}0.011$; of $25$ variants, $0$ help
...
improving generalization. The finding cuts two ways: it explains the
failures of concept-alignment supervision we report here, and---by locating
...
per-checkpoint non-significantly, \S\ref{sec:convergence}). The same valence
