...
null (top right) places the observed correlation beyond the null
support (a matched-norm random direction reads $r{=}0.07$); the
bottom-right panel shows the same cohort EEG$\leftrightarrow$V-axis
correlation across all $14$ LLMs. The axis is extracted with no EEG supervision.
